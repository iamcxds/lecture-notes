...
\end{definition}
\begin{exercise}
  Let $X\in \Set$, then $\Set/X$ is isomorphic to the category of $X$ indexed sets: objects are families of set $\{S_x\}_{x\in X}$, morphisms are families of maps $ \{f: S_x \to T_x\}_{x\in X}$.
\end{exercise}
\section{Functor}
